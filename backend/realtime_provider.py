...
class GeminiLiveProvider(RealtimeProvider):
    ...
    def __init__(self, instructions: str | None = None, tool_runner: Any = None,
        ...
        self.instructions = (
            ...
            "'where did we land', 'what did we decide', 'summarize what we "
            "discussed' — are answered from the live transcript only. Do NOT "
            "call ada_memory_search, ada_session_recall, or any memory tool for "
            "them: the threads you just discussed outrank stored facts even "
            "when a memory hit looks plausible. "
